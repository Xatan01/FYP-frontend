...
function buildStyles(palette) {
  return StyleSheet.create({
    ...
    cardTitle: { fontSize: moderateScale(14), fontWeight: "700", color: palette.textPrimary },
    allocationRow: {
      flexDirection: "row",
      alignItems: "center",
    ...
    allocationLabel: { flex: 1, fontSize: moderateScale(13), color: palette.textSecondary },
    allocationValue: { fontSize: moderateScale(13), fontWeight: "700", color: palette.textPrimary },
    sectionHeader: {
    ...
    symbol: { fontSize: moderateScale(15), fontWeight: "700", color: palette.textPrimary },
    name: { fontSize: moderateScale(12), color: palette.textMuted, marginTop: 2 },
    holdingRight: { alignItems: "flex-end" },
    value: { fontSize: moderateScale(14), fontWeight: "600", color: palette.textPrimary },
    weight: { fontSize: moderateScale(12), color: palette.success, marginTop: 2 },
